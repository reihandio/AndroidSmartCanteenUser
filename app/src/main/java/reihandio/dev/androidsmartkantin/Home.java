...
import reihandio.dev.androidsmartkantin.Model.Category;
import reihandio.dev.androidsmartkantin.Model.Token;
import reihandio.dev.androidsmartkantin.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token,false);//false karena dikirimkan melalui aplikasi pelanggan
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Get CategoryId dan Kirim ke new Activity
                        Intent foodList = new Intent(Home.this,FoodList.class);
                        //Karena kategori merupakan key, jadi ambil kunci dari item ini
